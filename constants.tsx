...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'The ultimate cursor registry for Shadcn/UI — a curated collection of 100+ high-end animated cursors. Engineered with Motion and designed for impact.',
    tags: ['Next.js', 'Framer Motion', 'TypeScript', 'Tailwind'],
    status: 'Featured',
    year: '2026',
    link: 'https://cursor-gallery.vercel.app/',
    imageUrl: '/cursor-gallery.png',
  },
  {
    title: 'Neonkit',
